"""Seed the incidentio root cause summary golden dataset into Braintrust.
...
Usage:
    cd matik/
    uv run python -m evals.summaries.incidentio_root_cause.seed_dataset
"""
...
DATASET_DESCRIPTION = "Fictional golden dataset for the incident root-cause summary eval (summary + resolution statement -> root cause)."
