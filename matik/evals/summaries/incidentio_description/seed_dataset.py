"""Seed the incidentio description summary golden dataset into Braintrust.
...
DATASET_DESCRIPTION = "Fictional golden dataset for the incident-description summary eval (incident name + summary -> concise description)."
