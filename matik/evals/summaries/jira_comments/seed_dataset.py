"""Seed the jira comments summary golden dataset into Braintrust.
...
Usage:
    cd matik/
    uv run python -m evals.summaries.jira_comments.seed_dataset
"""
...
DATASET_DESCRIPTION = "Fictional golden dataset for the Jira comments summary eval (aggregated comments -> discussion summary)."
