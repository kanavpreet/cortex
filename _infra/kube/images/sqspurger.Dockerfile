# Production Dockerfile for SQS Purger
...
# Install dependencies (boto3 is a core dep, no extras needed)
...
COPY --chown=matik:matik matik/sqspurger /app/sqspurger
...
# Run the SQS purger with dumb-init for proper signal handling
ENTRYPOINT ["dumb-init", "--"]
CMD ["python", "-m", "sqspurger"]
