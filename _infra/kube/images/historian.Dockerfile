...
# Install dependencies with historian extras only
RUN uv sync --frozen --no-install-project --no-dev --extra historian
...
COPY --chown=matik:matik matik/historian /app/historian
