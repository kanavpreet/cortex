# Production Dockerfile for Enricher Service
...
# Install dependencies (enricher has no extra dependencies beyond core)
...
COPY --chown=matik:matik matik/enricher /app/enricher
